...
using (var scope = app.Services.CreateScope())
{
    ...
    void SeedData(ApplicationDbContext context)
    {
        ...
        if (!context.Monsters.Any())
        {
            ...
            {
                new Monster { Name = "Gobelin", Health = 30, AttackPower = 5, Defense = 1, ScoreValue = 20 },
                new Monster { Name = "Orc", Health = 80, AttackPower = 12, Defense = 4, ScoreValue = 75 }
            });
        }
        ...
        if (!context.Items.Any())
        {
            ...
            {
                new Item { Name = "Potion de Vie", Description = "Soin 20 HP", Value = 10 },
